...
public class Medical_Records 
{
    ...
    private static void registerPatient() 
    {
     ...
     String patientId = readPatientId();
     ...
     Patient.PatientCategory category = readCategory();

     Patient patient;

     if (category == Patient.PatientCategory.INPATIENT) 
     {
    ...
    //validation for patientID
    private static String readPatientId() 
    {
     while (true) 
     {
      System.out.print("Patient ID (eg. P00001): ");

      String input = scanner.nextLine().trim();

      if (input.matches("P[0-9]{5}")) 
      {
       return input;
      }

      System.out.println("Invalid Patient ID.");
      System.out.println("Patient ID must be in the format P00001 ");
     }
    }
    ...
    private static String readName(String message) 
    {
     while (true) 
     {
      ...
      System.out.println("Invalid name. Names must contain letters only.");
     }
    }
    ...
    private static Patient.PatientCategory readCategory() 
    {
     while (true) 
     {
      System.out.println("\nPatient Category: ");
      ...
      switch (choice) 
      {
       case 1: return Patient.PatientCategory.INPATIENT;

       case 2: return Patient.PatientCategory.OUTPATIENT;

       case 3: return Patient.PatientCategory.EMERGENCY;
